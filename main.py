...
plt.scatter(knn_time, int(accuracy_score(y_test, knn_pred) * 100), s=50, marker="o", facecolor="black", label="K-Nearest Neighbors Algorithm")
plt.scatter(svc_time, int(accuracy_score(y_test, svc_pred) * 100), s=50, marker="^", facecolor="black", label="The method of support vectors")
plt.scatter(dt_time, int(accuracy_score(y_test, dt_pred) * 100), s=50, marker="s", facecolor="black", label="Decision Tree Classifier")
plt.scatter(gnb_time, int(accuracy_score(y_test, gnb_pred) * 100), s=50, marker="1", facecolor="black", label="Gaussian Naive Bayes")
plt.scatter(lda_time, int(accuracy_score(y_test, lda_pred) * 100), s=50, marker="*", facecolor="black", label="Linear Discriminant Analysis")
plt.scatter(lr_time, int(accuracy_score(y_test, lr_pred) * 100), s=50, marker="D", facecolor="black", label="Logistic Regression")
plt.legend()
plt.ylabel('Accuracy (%)')
